...
host_string=("pzl97@apt169.apt.emulab.net" "pzl97@apt182.apt.emulab.net" "pzl97@apt173.apt.emulab.net" "pzl97@apt192.apt.emulab.net" "pzl97@apt189.apt.emulab.net" "pzl97@apt174.apt.emulab.net" "pzl97@apt179.apt.emulab.net" "pzl97@apt167.apt.emulab.net")
name="deploy-client"
...
#   #tmux send -t $tmux_name "nohup ./earthd start --home=./workspace/earth/validator${i} > output 2>&1 & " Enter
  ...
  startID=`expr \( $i % 4 \) \* 4  `
  tmux send -t $tmux_name "nohup ./tpsclient $startID CrossChain $idCount 0 > output$idCount 2>&1 &" Enter
