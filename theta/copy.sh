...
host_string=(" root@10.10.1.1" " root@10.10.1.2" " root@10.10.1.3" " root@10.10.1.4" " root@10.10.1.5" " root@10.10.1.6" " root@10.10.1.7" " root@10.10.1.8" " root@10.10.1.9" )
...
do
  ...
  tmux send -t $tmux_name "scp /root/docker-lab1.zip  ${host_string[i]}:/root/" Enter
elif [ "$1" == "init" ]; then
  tmux send -t $tmux_name "ssh ${host_string[i]}" Enter
  tmux send -t $tmux_name "rm -rf docker-lab1/" Enter
  tmux send -t $tmux_name "unzip docker-lab1.zip" Enter
